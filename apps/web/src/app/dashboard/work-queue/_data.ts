...
export const WQ_JOBS: WQJob[] = [
  ...
  { id: 'j5',  title: 'OR Nurse',             client: "St. Luke's",           location: 'Houston, TX',    type: 'Contract',        billRate: '$90/hr',  priority: 'High',   vmsSource: 'Fieldglass',   receivedAt: '4h ago',    slaDue: 'Tomorrow 2:00 PM', slaHoursLeft: 26, status: 'in_progress',      assignedTo: 'James Rodriguez',candidatesReviewed: 8,  submitted: 2, interviewed: 0, aiScore: 89, tags: ['Travel OK'] },
  ...
  { id: 'j9',  title: 'NICU Nurse',           client: "Texas Children's",     location: 'Houston, TX',    type: 'Contract',        billRate: '$98/hr',  priority: 'Medium', vmsSource: 'Beeline',      receivedAt: 'Yesterday', slaDue: 'Jun 30 12:00 PM',  slaHoursLeft: 36, status: 'assigned',         assignedTo: 'Lisa Chen',      candidatesReviewed: 4,  submitted: 0, interviewed: 0, aiScore: 92, tags: [] },
  ...
  { id: 'j13', title: 'OR Tech',              client: "St. Luke's",           location: 'Houston, TX',    type: 'Contract',        billRate: '$65/hr',  priority: 'Low',    vmsSource: 'Beeline',      receivedAt: '3 days ago',slaDue: 'Jul 2 5:00 PM',    slaHoursLeft: 72, status: 'assigned',         assignedTo: 'Arun Kumar',     candidatesReviewed: 2,  submitted: 0, interviewed: 0, aiScore: 85, tags: [] },
  ...
  { id: 'j18', title: 'L&D RN',              client: "St. Luke's",           location: 'Houston, TX',    type: 'Contract',        billRate: '$88/hr',  priority: 'Medium', vmsSource: 'IQNavigator',  receivedAt: '5 days ago',slaDue: 'Jul 2 12:00 PM',   slaHoursLeft: 66, status: 'assigned',         assignedTo: 'James Rodriguez',candidatesReviewed: 3,  submitted: 0, interviewed: 0, aiScore: 83, tags: [] },
