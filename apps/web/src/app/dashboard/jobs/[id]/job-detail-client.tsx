                ...
                <div className="flex items-center gap-2.5 px-5 py-3 border-b shrink-0 bg-muted/10">
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="h-9 w-56 pl-9 pr-8 text-sm border border-input rounded-md bg-background focus-visible:outline-none focus-visible:border-[#D1D5DB] placeholder:text-muted-foreground"
                    />
                    {search && (
