        ...
        <div className="space-y-3.5">
          ...
          <div className="space-y-1.5">
            ...
            <textarea value={notes} onChange={e => setNotes(e.target.value)} rows={3}
              className="w-full text-sm border border-border rounded-md px-3 py-2 resize-none focus-visible:outline-none focus-visible:border-[#D1D5DB] placeholder:text-muted-foreground" />
          </div>
        </div>
        <DialogFooter>
            ...
            {savingView ? (
              <div className="flex items-center gap-1">
                <input autoFocus value={viewName} onChange={e => setViewName(e.target.value)}
                  ...
                  className="h-8 w-28 px-2.5 text-sm border border-border rounded-md focus-visible:outline-none focus-visible:border-[#D1D5DB]" />
