...
export const PROJECT_CANDIDATES = [
  ...
  { id: 'c2', name: 'James Wilson',   title: 'Sr. Java Developer',company: 'FinCore Inc',           exp: '10 yrs',skills: ['Java','Spring','AWS'],  location: 'Austin, TX',   auth: 'GC',  availability: '2 weeks',   recruiter: 'Sarah M.',   lastContact: '1 day ago',  aiScore: 91, stage: 'Interview Scheduled', tags: ['Priority'] },
  { id: 'c3', name: 'Sarah Chen',     title: 'ER Nurse',           company: 'Memorial Medical',      exp: '6 yrs', skills: ['ER','BLS','TNCC'],    location: 'Dallas, TX',   auth: 'USC', availability: '1 month',   recruiter: 'Emily T.',   lastContact: '5 days ago', aiScore: 84, stage: 'Reviewing',  tags: [] },
  ...
  { id: 'c5', name: 'Linda Torres',   title: 'OR Nurse',           company: 'Houston Methodist',     exp: '11 yrs',skills: ['OR','CNOR','Surgical'],location: 'Houston, TX',  auth: 'USC', availability: 'Immediate', recruiter: 'James R.',   lastContact: 'Today',      aiScore: 93, stage: 'Offer Sent', tags: ['Hot'] },
  { id: 'c6', name: 'Michael Grant',  title: 'Backend Engineer',   company: 'DataStream',            exp: '7 yrs', skills: ['Java','Kafka','Redis'], location: 'Chicago, IL',  auth: 'GC',  availability: '2 weeks',   recruiter: 'Sarah M.',   lastContact: '7 days ago', aiScore: 79, stage: 'Reviewing',  tags: [] },
  ...
  { id: 'c8', name: 'Carlos Rivera',  title: 'Full Stack Developer',company: 'StartupHub',           exp: '9 yrs', skills: ['Java','React','Docker'],location: 'Denver, CO',   auth: 'EAD', availability: '1 month',   recruiter: 'Arun Kumar', lastContact: '4 days ago', aiScore: 82, stage: 'Reviewing',  tags: [] },
]
