      ...
      <div className="space-y-4">
        ...
        >
          <CardRow label="Calendar integration">
            <select defaultValue="outlook" className="h-8 px-2 text-sm rounded-lg border border-input bg-background focus-visible:outline-none focus-visible:border-[#D1D5DB]">
