      ...
      <div className="space-y-4">
        ...
        >
          <div className="space-y-3">
            <CardRow label="Maximum file size">
              <select defaultValue="10" className="h-8 px-2 text-sm rounded-lg border border-input bg-background focus-visible:outline-none focus-visible:border-[#D1D5DB]">
            ...
            <CardRow label="Maximum batch upload">
              <select defaultValue="50" className="h-8 px-2 text-sm rounded-lg border border-input bg-background focus-visible:outline-none focus-visible:border-[#D1D5DB]">
        ...
        >
          <CardRow label="Primary storage provider">
            <select defaultValue="internal" className="h-8 px-2 text-sm rounded-lg border border-input bg-background focus-visible:outline-none focus-visible:border-[#D1D5DB]">
