        ...
        >
          <div className="space-y-3">
            <CardRow label="Default export format">
              <select defaultValue="csv" className="h-8 px-2 text-sm rounded-lg border border-input bg-background focus-visible:outline-none focus-visible:border-[#D1D5DB]">
            ...
            <CardRow label="Default date range">
              <select defaultValue="30d" className="h-8 px-2 text-sm rounded-lg border border-input bg-background focus-visible:outline-none focus-visible:border-[#D1D5DB]">
