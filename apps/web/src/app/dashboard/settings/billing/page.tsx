      ...
      <div className="space-y-4">
        ...
        <div className="rounded-xl bg-foreground text-background p-6 overflow-hidden relative">
          ...
          <div className="mt-6 flex items-center gap-3">
            <button className="h-9 px-4 text-sm rounded-lg bg-background text-foreground hover:bg-background/90 transition-colors font-medium">
              Upgrade plan
            </button>
            <button className="h-9 px-4 text-sm rounded-lg border border-background/30 text-background hover:bg-white/10 transition-colors">
              View all plans
            </button>
          </div>
        </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="col-span-2 space-y-1.5">
              ...
              <input defaultValue="•••• •••• •••• 4242"
                className="w-full h-9 px-3 text-sm rounded-lg border border-input bg-background focus-visible:outline-none focus-visible:border-[#D1D5DB] font-mono" />
            </div>
            ...
            {INVOICES.map((inv, i) => (
              <div key={i} className="flex items-center justify-between py-3 border-b border-border/40 last:border-0">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">{inv.amount} · Growth plan</p>
                </div>
