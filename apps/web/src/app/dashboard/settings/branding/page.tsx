          ...
          <div className="space-y-4">
            <div>
              ...
              <div className="flex items-center gap-4">
                ...
                <button className="h-9 px-4 text-sm rounded-lg border border-border hover:bg-muted/60 transition-colors flex items-center gap-2">
                  <Upload className="size-3.5" />Upload logo
                </button>
                <p className="text-sm text-muted-foreground">PNG, SVG. Max 2 MB.</p>
              </div>
            </div>
          ...
          summary={
            <div className="flex items-center gap-6">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-mono font-medium">{primaryColor}</span>
              </div>
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-mono font-medium">{accentColor}</span>
              </div>
            </div>
          }
        >
