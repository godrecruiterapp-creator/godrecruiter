            ...
            <CardRow label="Alert days before expiry">
              <div className="flex items-center gap-2">
                <input type="number" defaultValue={30} min={7}
                  className="w-16 h-8 text-center text-sm rounded-lg border border-input bg-background focus-visible:outline-none focus-visible:border-[#D1D5DB]" />
        ...
        >
          <div className="space-y-3">
            <CardRow label="Candidate data retention">
              <select defaultValue="3years" className="h-8 px-2 text-sm rounded-lg border border-input bg-background focus-visible:outline-none focus-visible:border-[#D1D5DB]">
            ...
            <CardRow label="Audit log retention">
              <select defaultValue="2years" className="h-8 px-2 text-sm rounded-lg border border-input bg-background focus-visible:outline-none focus-visible:border-[#D1D5DB]">
                <option value="1year">1 year</option>
                <option value="2years">2 years</option>
                <option value="5years">5 years</option>
              </select>
