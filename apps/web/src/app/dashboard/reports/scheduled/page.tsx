        ...
        <SheetContent className="w-[420px] flex flex-col gap-5 overflow-y-auto">
          ...
          <div className="flex flex-col gap-4">
            <div className="flex flex-col gap-1.5">
              ...
              <select className="h-8 text-sm border rounded-md px-2 bg-background focus-visible:outline-none focus-visible:border-[#D1D5DB]">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <div className="flex gap-2">
                <input
                  className="flex-1 h-8 px-2.5 text-sm border rounded-md bg-background focus-visible:outline-none focus-visible:border-[#D1D5DB]"
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <textarea
                className="min-h-[72px] px-2.5 py-2 text-sm border rounded-md bg-background resize-none focus-visible:outline-none focus-visible:border-[#D1D5DB]"
