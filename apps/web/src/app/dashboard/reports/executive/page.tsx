    ...
    <div className="flex flex-col h-full p-6 gap-4 overflow-y-auto">
      <div className="flex items-start justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          <select className="h-8 text-sm border rounded-md px-2 bg-background focus-visible:outline-none focus-visible:border-[#D1D5DB]"><option>YTD 2026</option><option>Last Quarter</option></select>
